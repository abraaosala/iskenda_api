...
API REST do site institucional da IS KENDA. Permite gerenciar conteúdos como serviços, clientes, membros da equipa, galeria, cursos, valores da empresa e informações de contacto.

## Autenticação

A maioria dos endpoints requer um token de acesso **Sanctum (Bearer Token)**. Para obter um token, utilize o endpoint `/api/auth/login` com as credenciais de administrador.
